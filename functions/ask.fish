function ask -a query
  ...
  # Build JSON payload using jq to properly escape the prompt (non-streaming)
  ...
  # Process response: convert escape sequences and remove quotes
